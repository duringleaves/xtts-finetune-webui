    ...
    for audio_path in tqdm_object:
        ...
        for word_idx, word in enumerate(words_list):
            ...
            if word.word[-1] in ["!", "。", ".", "?"]:
                ...
                # Add a buffer to ensure the final word is not cut off
                word_end = min(next_word_start - 0.01, word.end + 0.4) #0.4 second buffer, or just before the next segment start time
