...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        with gr.Tab("1 - Data processing"):
            ...
            def preprocess_dataset(audio_path, audio_folder_path, language, whisper_model, out_path, train_csv, eval_csv, speaker_name, progress=gr.Progress(track_tqdm=True)):
                clear_gpu_cache()
